...
onAuthStateChanged(auth, async (user) => {
    if (user) {
        ...
        const googleFonts = ["Abel", "Abril Fatface", "Acme", "Aladin", "Amatic SC", "Anton", "Architects Daughter", "Bebas Neue", "Bitter", "Caveat", "Comfortaa", "Cookie", "Dancing Script", "Great Vibes", "Indie Flower", "Josefin Sans", "Jost", "Lobster", "Montserrat", "Pacifico", "Playfair Display", "Poppins", "Quicksand", "Raleway", "Roboto", "Shadows Into Light"];
